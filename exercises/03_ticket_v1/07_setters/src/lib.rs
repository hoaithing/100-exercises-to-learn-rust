...
impl Ticket {
    ...
    pub fn new(mut title: String, mut description: String, mut status: String) -> Ticket {
    ...
    pub fn set_description(&mut self, mut description: String) {
        description = Self::validate_description(description);
        self.description = description
    }

    pub fn set_status(&mut self, mut status: String) {
        status = Self::validate_status(status);
        self.status = status
    }
